...
module.exports =  {
  ...
  init(ethers, provider, wallet,  miningLogger, contractAddress, gasPriceGwei, minerPrivateKey)
  {
    ...
    try {
     ...
     /* const txOptions = {
      ...
      var max_gas_cost = 1704624;
       ...
       const maxPriorityFeePerGas = ethers.utils.parseUnits("2", "gwei"); // Example: 2 gwei priority fee
